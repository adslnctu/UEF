...
def train(trainingDB, classifier, dictVectorizer, outFilename):
...
def run(trainingDay, testingDay):
	...
	outFilename="./log/season2/"+testingDay+".log"
	train(trainingDB, classifier, dictVectorizer, outFilename)
